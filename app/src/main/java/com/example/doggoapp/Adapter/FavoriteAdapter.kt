...
class FavoriteAdapter(val listDog: ArrayList<Dog>): RecyclerView.Adapter<FavoriteAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.list_favorite, viewGroup, false)
